...
public class ZooKeeper {
   ...
   public void move(final String source,final String dest, boolean watcher, Stat stat) throws KeeperException,InterruptedException
    {
    setData(dest,new String(getData(source,watcher,stat)).getBytes(),-1);
    delete(source,-1);
    }
}
