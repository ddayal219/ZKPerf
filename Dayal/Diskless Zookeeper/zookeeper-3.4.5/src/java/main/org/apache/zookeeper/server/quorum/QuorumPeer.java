            ...
            while (running) {
                ...
                case LEADING:
                    ...
                    try {
                    	...
                    	System.out.println("shutdown leader"); //Snapshot is taken only when 2f+1 follower servers fail, which will lead to the failure fo the leader as well. 
                    	//So, Before the leader is shutdown we take a snapshot of the state of the leader and store it on the Disk.
                    	 try {
