...
2. Only Snapshots are taken. Snapshots are taking depending upon Fuzzy snapcount, see link 6 below.

3. See link 5 for Restoration Guarantees of Diskless Zookeeper.
